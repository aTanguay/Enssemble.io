# Getting Started with XIAO MIDI Synthesizer

URL: https://wiki.seeedstudio.com/xiao_midi_synthesizer/

![](https://files.seeedstudio.com/wiki/xiao_midi_synthesizer/1.jpg)

[**Get One Now 🖱️**](https://www.seeedstudio.com/XIAO-MIDI-Synthesizer-p-6462.html)
...
| Instrument Presets | Over 100 different instrument sounds available 
| Interfaces and Connectivity 
| 3.5mm Audio Jack | Used to connect external audio devices (e.g., speakers or headphones)
Features auto-disabling of the Class D amplifier when a cable is inserted and re-enabling when removed 
| Physical Buttons | Four side-mounted physical buttons for user interaction 
| XIAO Socket | A dedicated socket designed for the XIAO module, with expansion capability via additional side connectors 
| D-Class Amplifier | Build-in Speaker 
| Power and Indicators 
| Power Supply | 5V Type-C 
| Indicator LED | A single-color LED used to indicate power status and provide user feedback 

![](https://files.seeedstudio.com/wiki/xiao_midi_synthesizer/3.png)
![](https://files.seeedstudio.com/wiki/xiao_midi_synthesizer/4.png)
...
![](https://files.seeedstudio.com/wiki/xiao_midi_synthesizer/7.png)
...
![](https://files.seeedstudio.com/wiki/xiao_midi_synthesizer/5.jpg)
...
[**Download the Code**](ttps://github.com/Seeed-Studio/Seeed_Arduino_MIDIMaster)
...
| ![](https://files.seeedstudio.com/wiki/xiao_midi_synthesizer/6.jpg) 
| [**Get One Now 🖱️**](https://www.seeedstudio.com/XIAO-MIDI-Synthesizer-p-6462.html) 
...
1. Allows for stabilization with a timing delay
...
2. [The Wild West MIDIs](https://thewildwestmidis.github.io/?search=animals)
3. [LibreScore MIDI Library](https://github.com/LibreScore/app-librescore?tab=readme-ov-file#installation)
4. Convert the MIDI File to Text
...
5. Convert the MIDI Text to Playable Code
...
1. Copy the generated array into your Arduino sketch, replacing the melody data.
tip
...
6. **Fast rhythm, single track (each note start as interval):**
[change_fast.py](https://files.seeedstudio.com/wiki/xiao_midi_synthesizer/res/change_fast.py)
7. **Slower rhythm, single track (each note end as interval):**
[change_shuqing.py](https://files.seeedstudio.com/wiki/xiao_midi_synthesizer/res/change_shuqing.py)
8. **Multi-track processing:**
[change_mutich.py](https://files.seeedstudio.com/wiki/xiao_midi_synthesizer/res/change_mutich.py)
9. Place your MIDI text file (e.g., `1.txt` ) in the same directory as the script.
10. Run the script in your terminal:
11. Copy the generated array into your Arduino sketch, replacing the melody data.
12. The scripts map MIDI note numbers to the XIAO MIDI Synthesizer's note definitions automatically.
13. You can adjust the script or the generated array for custom arrangements or to fit memory constraints.
14. Integrate the Generated Code
15. Open the generated `.h` file and copy the `musicData` array.
16. Paste it into your Arduino project, replacing the existing melody array.
17. Update your playback logic if needed to match the new array structure.
