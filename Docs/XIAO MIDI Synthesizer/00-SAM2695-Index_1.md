...
- [[18-SAM2695-Ensemble-Voice-Pattern]] — multitimbral GM behavior explained, plus the broadcast-Program-Change pattern for making a unit respond as "one voice, any channel" (for multi-unit room ensembles over BLE MIDI)
